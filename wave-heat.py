...
time_operator = "Euler"  ## chose 'Euler', 'BDF2', 'Newmark'
ell           = 1
#-----------------------------
...
for i in range(num_space):
    ...
    for j in range(num_time):
        ...
        with io.XDMFFile(domain.comm, "SIM/" + addfolder + "wave-heat-vnew.xdmf", "w") as xdmf:
            ...
            for tk in range(1,N):
                ...
                # errorpp_max[i] = np.max(np.abs(pp_ex.x.array - pp.x.array)) 
...
scipy.io.savemat('Errors/errors_deg' + str(ell) + '_' + time_operator + '_'+ modeltype + '.mat', 
