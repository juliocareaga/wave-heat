...
activatelinear = 1 ## 1 linear;  0 : nolineal
#-----------------------------
tau = 1e-7
T   = 400*tau
    ...
    if True:
        ...
        with io.XDMFFile(domain.comm, "SIM/" + addfolder + namesim + ".xdmf", "w") as xdmf:
            ...
            while t <= T: # t = tn
                ...
                I_DT_Focus = death_tissue.eval(points_on_proc,cells)            
...
scipy.io.savemat( 'SIM/Example3/' + modeltype + '/death_tissue_' + modeltype  + labelin +  '.mat', 
